...
| **Empty results**    | Inputs that match nothing. Verify the response explains _why_ (echoes criteria, suggests broadening) rather than returning a bare empty array.                                                                                                                                                                                                                                                                                     |
